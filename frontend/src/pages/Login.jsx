      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={submit} className="bg-white p-8 rounded-3xl shadow-2xl border border-slate-100 space-y-6">
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
